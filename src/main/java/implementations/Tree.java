...
public class Tree<E> implements AbstractTree<E> {
    ...
    public void addChild(E parentKey, Tree<E> child) {
        Tree<E> search = findRecursive(parentKey);
    ...
    private Tree<E> findRecursive(E parentKey) {
        Deque<Tree<E>> childrenQueue = new ArrayDeque<>();
        childrenQueue.offer(this);
    ...
    public void removeNode(E nodeKey) {
        Tree<E> toRemove = findRecursive(nodeKey);
    ...
    public void swap(E firstKey, E secondKey) {
        Tree<E> firstNode = findRecursive(firstKey);
        Tree<E> secondNode = findRecursive(secondKey);
    ...
    public void swapRoot(Tree<E> node) {
